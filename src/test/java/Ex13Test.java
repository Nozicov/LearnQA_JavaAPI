...
public class Ex13Test {
    ...
    public void testUserAgent(String userAgent, String platform, String browser, String device){
        ...
        assertEquals(platform, responsePlatform, "Not correct response platform");
        assertEquals(browser, responseBrowser, "Not correct response browser");
        assertEquals(device, responseDevice, "Not correct response device");
